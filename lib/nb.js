...
var NB = /** @class */ (function () {
    ...
    NB.prototype.runServe = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var nexts, env, childProcess;
            return tslib_1.__generator(this, function (_a) {
                nexts = this.args.slice(1);
                env = this.getArgValueIfExists(nexts, '--env');
                childProcess = cp.exec("webpack-dev-server --env=" + (env ? env : 'local') + " --devtool source-map --colors");
    ...
    NB.prototype.runBuild = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var nexts, env, childProcess;
            return tslib_1.__generator(this, function (_a) {
                nexts = this.args.slice(1);
                env = this.getArgValueIfExists(nexts, '--env');
                childProcess = cp.exec("webpack --env=" + (env ? env : 'prod') + " --colors");
                childProcess.stdout.on('data', function (data) {
                    console.log(data);
                });
                childProcess.stderr.on('data', function (data) {
