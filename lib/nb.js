...
var NB = exports.NB = /** @class */ (function () {
    function NB(logger) {
        this.logger = logger;
        this.initialArgs = [];
        this.args = [];
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        answer_1 = _b.sent();
                        cli_1.CLI.inject('Build').execute(["--env=".concat(answer_1.value)]);
                        return [3 /*break*/, 6];
                    case 5:
    ...
    NB.prototype.getAllExistingsEnviroments = function () {
        var envs = [];
        if (fs_extra_1.default.pathExistsSync("".concat(process.cwd(), "/src/environments"))) {
            fs_extra_1.default.readdirSync("".concat(process.cwd(), "/src/environments")).forEach(function (file) {
