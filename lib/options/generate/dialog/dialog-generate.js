...
var DialogGenerate = exports.DialogGenerate = /** @class */ (function (_super) {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        fileDirInstruction = {
                            name: this.fileName,
                            children: [
                                { name: "".concat(this.fileName, ".dialog.html"), content: this.replaceVariablesInContentFile(dialog_generate_template_1.DIALOG_HTML) },
                                { name: "".concat(this.fileName, ".dialog.scss"), content: this.replaceVariablesInContentFile(dialog_generate_template_1.DIALOG_SCSS) },
                                { name: "".concat(this.fileName, ".dialog.ts"), content: this.replaceVariablesInContentFile(dialog_generate_template_1.DIALOG_TS) },
                            ]
                        };
                        if (lastDirectory)
