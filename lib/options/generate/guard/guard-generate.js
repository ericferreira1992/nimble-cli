...
var guard_generate_template_1 = require("./guard-generate-template");
var base_generate_1 = require("../base-generate");
var GuardGenerate = exports.GuardGenerate = /** @class */ (function (_super) {
    tslib_1.__extends(GuardGenerate, _super);
    function GuardGenerate(logger) {
        var _this = _super.call(this) || this;
        _this.logger = logger;
        return _this;
    }
    GuardGenerate.prototype.execute = function () {
    ...
    GuardGenerate.prototype.question = function () {
    ...
    ;
    GuardGenerate.prototype.isValid = function (name) {
        if (name === '') {
    ...
    GuardGenerate.prototype.startCreateSerivce = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var creator, fileInstructions, lastDirectory;
            var _a;
            var _this = this;
                    ...
                    case 0:
                        ...
                        if (lastDirectory)
                            lastDirectory.children.push({
                                name: "".concat(this.fileName, ".guard.ts"),
    ...
    GuardGenerate.prototype.getValueByName = function (name) {
        switch (name) {
            case 'Name':
