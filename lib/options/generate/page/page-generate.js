...
var PageGenerate = /** @class */ (function (_super) {
    ...
    PageGenerate.prototype.replaceVariablesInContentFile = function (content) {
        var _this = this;
        var regex = /\[\[(.|\n)*?\]\]/g;
