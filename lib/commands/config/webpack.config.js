...
function getPlugins(inBuilding, env) {
    var _a, _b, _c, _d;
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var baseHref, willUseBaseHref, plugins, _e, _f, _g, _h, _j, _k, _l, preRender, preRenderRoutes, preRenderEnabled, willUsePreRender, routes;
        return tslib_1.__generator(this, function (_m) {
            switch (_m.label) {
                case 0:
                    ...
                    _e = [new clean_webpack_plugin_1.default(),
                ...
                case 1:
                    plugins = _e.concat([
                        new (_g.apply(_f, [void 0, (_h[_j] = _l.apply(_k, [_m.sent()]),
                                _h)]))()
                    ]);
