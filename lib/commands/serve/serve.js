            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        urls = (0, webpack_dev_server_utils_1.prepareUrls)(protocol, this.host, this.port);
                        compiler = (0, webpack_dev_server_utils_1.createCompiler)({
                            appName: appName,
                            config: config,
                            urls: urls,
                            useYarn: false,
                        ...
                        devServer = new webpack_dev_server_1.default({
                            host: this.host,
                            port: this.port,
