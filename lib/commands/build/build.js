...
var Build = /** @class */ (function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, webpack_config_1.webpackConfig(this.env, options, true)];
                    case 1:
                        config = _a.sent();
                        this.build(config)
                            .then(function (_a) {
    ...
    Build.prototype.build = function (config) {
        ...
        if (fs_extra_1.default.existsSync(process.cwd() + "/src/environments/env." + this.env + ".js")) {
            console.log('❯ Using environment:', chalk_1.default.yellow("src/environments/env." + this.env));
        }
        else {
