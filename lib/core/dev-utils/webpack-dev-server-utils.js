...
function createCompiler(_a) {
    var appName = _a.appName, config = _a.config, urls = _a.urls, webpack = _a.webpack;
    ...
    compiler.hooks.invalid.tap('invalid', function () {
        if (isInteractive) {
            (0, dev_various_utils_1.clearConsole)();
        }
    ...
    compiler.hooks.done.tap('done', function (stats) {
        ...
        var messages = (0, format_webpack_msgs_1.formatWebpackMessages)(statsData);
